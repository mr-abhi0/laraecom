                             ...
                             <x-validation-errors class="mb-4" />
								<form class="form-stl" method="POST" action="{{ route('register') }}" name="frm-login"  >
									...
									<fieldset class="wrap-input">
										...
										<input type="text" id="frm-reg-lname" name="name" placeholder="Full name*" required autofocus autocomplete="name">
									</fieldset>
									<fieldset class="wrap-input">
										<label for="frm-reg-email">Email Address*</label>
										<input type="email" id="frm-reg-email" name="email" placeholder="Email address" required autocomplete="username">
									</fieldset>
